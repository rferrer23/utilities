 ...
 */
public class NumberFormatter extends NumberUtils{
  ...
  public static NumberFormatter getInstance(NumberFormat format) {
  ...
  private NumberFormatter(NumberFormat format) {
    ObjectUtils.notNull(format, "format");
  ...
  public static NumberFormatter ofPattern(String pattern, Locale locale) {
	  ObjectUtils.notNull(pattern, "pattern");
	  ObjectUtils.notNull(locale, "locale");
